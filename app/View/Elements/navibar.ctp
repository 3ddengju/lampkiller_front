...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				<li><?php 
				echo  $this->Html->link('Categories',array('controller'=>'categories','action'=>'index'));		
				?></li>
				<li><?php 
				echo  $this->Html->link('Classes',array('controller'=>'classifications','action'=>'index'));		
				?></li> 	
				<li><?php 
				echo  $this->Html->link('Details',array('controller'=>'details','action'=>'index'));		
				?></li> 
                  <!-- categories表-->
